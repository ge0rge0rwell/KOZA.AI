...
export const LOCAL_STORY_PAGES = [
    ...
    ['İlk Adım', 'Teneffüs zili çaldığında kalbi hızlıydı ama adımları kararlıydı. Rehber öğretmenin kapısını tıklattı. İçeri girdiğinde kelimeler önce dağınık döküldü, sonra yerini buldu. Öğretmeni onu bölmeden dinledi ve şöyle dedi: "Bunu anlatman büyük bir cesaret." Görkem, omuzlarındaki görünmez karın eridiğini hissetti. Yalnız taşıdığı yük, paylaşınca yarıya inmişti.'],
    ['Yan Yana', 'Sonraki günlerde bir şeyler usulca değişti. Sınıftan iki kişi, olanları fark ettiklerini ve yanında olduklarını söyledi. Birlikte yemek yediler, birlikte güldüler. Görkem fark etti: fısıltılar hâlâ ara sıra duyuluyordu ama artık aynı güçte çarpmıyordu; çünkü yanında duran insanlar, sözlerden daha gerçekti. Bir koza, içinde büyüyen kanatları sonsuza dek saklayamazdı.'],
    ['Yeni Bir Duruş', 'Aynı koridorlar, aynı ziller... Ama farklı bir Görkem. Başı dik yürüyor, gözleri yere değil ileriye bakıyordu. Bir gün, ona söylenen eski bir söz tekrar edildiğinde derin bir nefes aldı ve sakin bir sesle "Bu sözün bana bir etkisi yok artık." dedi, sonra arkadaşlarının yanına yürüdü. Söz, havada asılı kaldı ve sahibine geri döndü. Kozanın kabuğu, içeriden açılmıştı.'],
    ['Bir Kanat da Sen Ol', 'Hafta sonu okul bahçesinde, köşede tek başına oturan yeni öğrenciyi gördü. O bakışı tanıyordu; bir zamanlar aynaya bakan kendi gözleriydi onlar. Yanına gitti, "Yanına oturabilir miyim?" diye sordu. Küçük bir soru, ama o çocuğun gözlerindeki buzu eritmeye yetti. Görkem o gün anladı: kendi zorluğu, başkasını fark eden bir pusulaya dönüşmüştü.'],
    ['Kanatların Hatırası', 'Görkem artık biliyor: o günler hikâyesinin sonu değil, kozasının evresiydi. Hâlâ zor günler olabilir; kelebekler de rüzgârda zorlanır. Ama kanatları var artık — sabrından, cesaretinden ve uzattığı elden örülmüş kanatlar. Masasındaki kâğıtta hâlâ aynı cümle yazıyor: "Bana söylenen sözler, benim kim olduğum değil." Ve altında yeni bir satır: "Ben, kendi hikâyemin yazarıyım."'],
];
